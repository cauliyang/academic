...
subtitle: "Concrete description about how to config a mac"
summary: "How to config a mac and share apps or tools I used for production"
authors: ["admin"]
tags: ["configuration"]
categories: ["mac"]
...
- [1. Applications and Tools](#1-applications-and-tools)
  - [1.1 System Environment](#11-system-environment)
- [2. Editor](#2-editor)
